package com.caixy.shortlink.manager.oauth.strategy;
...
import com.caixy.shortlink.model.dto.oauth.github.GithubCallbackRequest;
import com.caixy.shortlink.model.dto.oauth.github.GithubCallbackResponse;
 ...
 *
 * @Author CAIXYPROMISE
 * @name com.caixy.shortlink.manager.oauth.GithubOAuthActionStrategyIml
...
//                   .githubUserName(userProfileDTO.getLoginUserName())
                   ...
                   .userName(userProfileDTO.getLoginUserName())
