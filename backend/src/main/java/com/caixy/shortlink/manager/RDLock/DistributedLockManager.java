package com.caixy.shortlink.manager.RDLock;

import com.caixy.shortlink.annotation.InjectRedissonClient;
import com.caixy.shortlink.common.ErrorCode;
import com.caixy.shortlink.exception.BusinessException;
import com.caixy.shortlink.model.enums.RDLockKeyEnum;
 ...
 *
 * @author CAIXYPROMISE
 * @name com.caixy.shortlink.manager.RDLock.DistributedLockManager
...
public class DistributedLockManager
{
                                          ...
                                          String errorMessage)
    {
        ...
        finally
        {
            ...
            {
                outUnlockLog(Thread.currentThread().threadId());
                rLock.unlock();
            }
        }
    }
