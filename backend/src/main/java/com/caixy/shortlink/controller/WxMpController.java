...
import com.caixy.shortlink.wxmp.WxMpConstant;
...
public class WxMpController
{
            ...
            throws IOException
    {
        ...
        // 加密类型
        String encryptType = StringUtils.isBlank(
        ...
        if ("aes".equals(encryptType))
        {
            ...
            WxMpXmlMessage inMessage = WxMpXmlMessage.fromEncryptedXml(
                            ...
                            wxMpService.getWxMpConfigStorage(), timestamp,
                            nonce,
                            msgSignature);
    ...
    public String setMenu() throws WxErrorException
    {
        ...
        wxMenuButton3SubButton1.setUrl("https://caixy.icu");
